    ...
    >
      ...
      <main className="rp-main" style={{
        ...
        <div className="rp-left" style={{ flex: 1, maxWidth: 580, paddingTop: 8 }}>
          ...
          <p style={{ fontSize: 14.5, lineHeight: 1.85, color: 'rgba(255,255,255,.5)', marginBottom: 30, maxWidth: 420, fontWeight: 300 }}>Alisado de vanguardia, pestañas y packs premium.<br />Realzamos tu esencia, potenciamos tu belleza.</p>
      ...
      <div className="rp-wa-wrap" style={{ display: 'flex', justifyContent: 'center', padding: '10px 0 40px', position: 'relative', zIndex: 10 }}>
        <a href="https://wa.me/5491130860274" target="_blank" rel="noopener noreferrer" className="rp-wa-btn">
